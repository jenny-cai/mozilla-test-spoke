...
# include: "//mozilla/monitoring/explores/*"

# TODO: remove unnecessary view imports
# include: "//mozilla/monitoring/views/airflow_dag.view.lkml"
# include: "//mozilla/monitoring/views/airflow_dag_note.view.lkml"
# include: "//mozilla/monitoring/views/airflow_dag_owner_attributes.view.lkml"
# include: "//mozilla/monitoring/views/airflow_dag_run.view.lkml"
# include: "//mozilla/monitoring/views/airflow_dag_tag.view.lkml"
# include: "//mozilla/monitoring/views/airflow_dag_warning.view.lkml"
# include: "//mozilla/monitoring/views/airflow_import_error.view.lkml"
# include: "//mozilla/monitoring/views/airflow_job.view.lkml"
# include: "//mozilla/monitoring/views/airflow_slot_pool.view.lkml"
# include: "//mozilla/monitoring/views/airflow_task_fail.view.lkml"
# include: "//mozilla/monitoring/views/airflow_task_instance.view.lkml"
# include: "//mozilla/monitoring/views/airflow_task_instance_note.view.lkml"
# include: "//mozilla/monitoring/views/airflow_task_reschedule.view.lkml"
# include: "//mozilla/monitoring/views/airflow_trigger.view.lkml"
# include: "//mozilla/monitoring/views/airflow_user.view.lkml"
# include: "//mozilla/monitoring/views/bigquery_table_storage.view.lkml"
# include: "//mozilla/monitoring/views/bigquery_table_storage_timeline_daily.view.lkml"
...
# include: "//mozilla/monitoring/views/column_size.view.lkml"
# include: "//mozilla/monitoring/views/event_error_monitoring_aggregates.view.lkml"
...
# include: "//mozilla/monitoring/views/mlops_job_cost_per_job.view.lkml"
# include: "//mozilla/monitoring/views/mlops_job_cost_per_job_run.view.lkml"
# include: "//mozilla/monitoring/views/payload_bytes_error_all.view.lkml"
...
# include: "//mozilla/monitoring/views/stable_and_derived_table_sizes.view.lkml"

...
explore: firefox_ios_feature_usage_events_not_added {
  sql_always_where: ${firefox_ios_dau.submission_date} >= '2023-06-01'
    AND ${firefox_ios_feature_usage_events_not_added.submission_date} >= '2023-06-01'
    ;;

  always_filter: {
    filters: [
      firefox_ios_dau.submission_date: "28 days ago for 27 days",
      firefox_ios_feature_usage_events_not_added.submission_date: "28 days ago for 27 days",
    ]
  }
